    ...
    <div class="mb-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <button onclick="closeShowModal(); openEditModal({{ $produto->id }});" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium transition-all duration-200 shadow-md hover:shadow-lg">
